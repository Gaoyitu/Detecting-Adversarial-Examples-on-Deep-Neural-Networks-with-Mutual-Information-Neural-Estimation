...
def get_stl10_vgg16():
    conv_base = tf.keras.applications.VGG16(weights='imagenet', include_top=False, input_shape=(96, 96, 3))
    # conv_base.summary()
    ...
    model.load_weights('networks/stl10/classifiers/stl10_vgg16_weights.h5')

    return model,conv_base

def get_stl10_resnet50():
    conv_base = tf.keras.applications.ResNet50(weights='imagenet', include_top=False, input_shape=(96, 96, 3))
    # conv_base.summary()
    ...
    model.load_weights('G:/datasets_and_networks/stl10/classifiers/stl10_resnet50_weights.h5')

    return model

def get_stl10_densenet121():
    ...
    model.load_weights('networks/stl10/classifiers/stl10_densenet121_weights.h5')

    return model,conv_base

def get_stl10_mobilenet():
    conv_base = tf.keras.applications.MobileNet(weights='imagenet', include_top=False, input_shape=(96, 96, 3))
    # conv_base.summary()
    ...
    model.load_weights('networks/stl10/classifiers/stl10_mobilenet_weights.h5')
